    ...
    <section className="bg-white py-24 pb-32 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <motion.div 
          ...
          className="relative bg-gradient-to-br from-[#0052D4] via-[#4364F7] to-[#6FB1FC] rounded-[2.5rem] md:rounded-[3.5rem] p-10 md:p-20 text-center shadow-[0_20px_50px_-12px_rgba(67,100,247,0.5)] hover:shadow-[0_30px_60px_-12px_rgba(67,100,247,0.6)] overflow-hidden"
        >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 w-full sm:w-auto">
              <Link href="#prebook" className="w-full sm:w-auto block">
                <motion.div 
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="group relative bg-white text-blue-600 font-bold px-8 py-4 rounded-2xl flex items-center gap-3 w-full justify-center overflow-hidden shadow-xl"
                >
              ...
              <Link href="#contact" className="w-full sm:w-auto block">
                <motion.div 
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="group bg-white/10 backdrop-blur-sm border border-white/30 text-white font-semibold px-8 py-4 rounded-2xl transition-all flex items-center gap-3 w-full justify-center shadow-lg hover:border-white/50"
                >
